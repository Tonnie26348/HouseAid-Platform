    ...
    <DashboardLayout pageTitle="My Team">
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
           <div>
             <h2 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Your Professional Team</h2>
             <p className="text-gray-500 font-medium text-sm md:text-base">Overview of active staff and their performance status.</p>
           </div>
           <Button asChild size="lg" className="rounded-xl h-12 md:h-14 px-6 md:px-8 font-black shadow-lg shadow-primary/20 w-full md:w-auto">
        ...
        {workers.length === 0 ? (
          <div className="text-center py-20 md:py-24 bg-white rounded-[2rem] md:rounded-[3rem] border border-dashed border-gray-200 px-6">
            ...
            <h3 className="text-lg md:text-xl font-bold text-gray-900">No professionals hired yet</h3>
            <p className="text-gray-500 max-w-xs mx-auto mb-8 text-sm md:text-base">Start your recruitment journey by browsing our verified domestic professionals.</p>
            <Button asChild size="lg" className="rounded-xl h-12 px-8 font-bold w-full sm:w-auto">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {workers.map((worker, idx) => (
              ...
              >
                <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-none shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden bg-white group">
                  <CardContent className="p-0">
                    <div className="p-6 md:p-8">
                      ...
                      <div className="space-y-1 mb-6">
                        <h3 className="text-xl md:text-2xl font-black text-gray-900 truncate">{worker.full_name}</h3>
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        <Button variant="outline" className="flex-1 rounded-xl font-bold border-2 h-11 md:h-12" asChild>
                          <Link to={`/platform/profile`}>Details</Link>
                        </Button>
                        <Button className="flex-1 rounded-xl font-bold shadow-lg shadow-primary/10 h-11 md:h-12 gap-2">
